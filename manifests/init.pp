...
#
#   $gateway
#       The default gateway to be configured. Remember that only the last
#       configured gateway will be used. (optional)
#
# Actions:
#   Ensures that the appropriate python libraries are installed and ensures
#   that the correct source code revisions are installed via git
#
# Sample Usage:
#
...
define managed_interface($ipaddr, $netmask, $up=true, $network='',
        $hwaddr='', $gateway='') {
